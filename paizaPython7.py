...
#03:引数と戻り値を追加しよう
#プログラミング言語Pythonの引数と戻り値について学習します。そして、関数を定義する時、引数と戻り値をどんなふうに記述するのか理解しましょう。
...
#04:スコープを理解しよう
#変数の有効範囲であるスコープについて学習します。スコープは、関数定義などを使いこなすため重要な機能ですので、しっかりと理解しましょう。
...
#06:引数のデフォルト値
#関数で引数を省略した場合に利用できるデフォルト値や、可変長引数という便利な記述方法について学習します。
...
#        when function called with blank argument 
#        and set default value as argument
#   caution:
